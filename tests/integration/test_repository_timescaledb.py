...
class TestQuoteRepositoryIntegration:
    ...
    def test_bulk_insert_and_retrieve(self, db_session):
        ...
        quotes = [
            ...
            {
                "symbol": "AAPL",
                "timestamp": datetime(2025, 12, 22, 10, 1, tzinfo=UTC),
                "open": 180.50,
                "high": 181.50,
                "low": 180.00,
                "close": 180.75,
            ...
            {
                "symbol": "AAPL",
                "timestamp": datetime(2025, 12, 22, 10, 2, tzinfo=UTC),
                "open": 180.75,
                "high": 182.00,
                "low": 180.50,
                "close": 181.25,
        ...
        results = repo.get_quotes(
            "AAPL", datetime(2025, 12, 22, tzinfo=UTC), datetime(2025, 12, 23, tzinfo=UTC)
        )
        ...
        # Cleanup
        db_session.execute(text("DELETE FROM quotes.real_time WHERE source = 'test'"))
        db_session.commit()
    ...
    def test_get_latest_quote(self, db_session):
        ...
        quotes = [
            ...
            {
                "symbol": "MSFT",
                "timestamp": datetime(2025, 12, 22, 10, 5, tzinfo=UTC),
                "close": 422.00,
                "source": "test",
            },
            {
        ...
        assert latest.timestamp == datetime(2025, 12, 22, 10, 5, tzinfo=UTC)
    ...
    def test_get_intraday_quotes(self, db_session):
        ...
        quotes = [
            {
                "symbol": "GOOGL",
                "timestamp": datetime(2025, 12, 21, 15, 30, tzinfo=UTC),
                "close": 140.00,
                "source": "test",
            },
            {
                "symbol": "GOOGL",
                "timestamp": datetime(2025, 12, 22, 9, 30, tzinfo=UTC),
                "close": 141.00,
                "source": "test",
            },
            {
                "symbol": "GOOGL",
                "timestamp": datetime(2025, 12, 22, 12, 0, tzinfo=UTC),
                "close": 142.00,
                "source": "test",
            },
            {
                "symbol": "GOOGL",
                "timestamp": datetime(2025, 12, 22, 16, 0, tzinfo=UTC),
                "close": 143.00,
                "source": "test",
            },
            {
                "symbol": "GOOGL",
                "timestamp": datetime(2025, 12, 23, 10, 0, tzinfo=UTC),
                "close": 144.00,
                "source": "test",
            },
        ]
        ...
        intraday = repo.get_intraday_quotes("GOOGL", datetime(2025, 12, 22, tzinfo=UTC))
    ...
    def test_get_quotes_with_limit(self, db_session):
        ...
        # Get only first 5
        results = repo.get_quotes(
            "TSLA", datetime(2025, 12, 22, tzinfo=UTC), datetime(2025, 12, 23, tzinfo=UTC), limit=5
        )
    ...
    def test_count_quotes(self, db_session):
        ...
        count_range = repo.count_quotes(
            symbol="META",
            start_date=datetime(2025, 12, 22, 10, 2, tzinfo=UTC),
            end_date=datetime(2025, 12, 22, 10, 4, tzinfo=UTC),
        )
